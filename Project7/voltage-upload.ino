...
byte mac[] = { 0x00, 0xAA, 0xBB, 0xCC, 0xDE, 0x30 }; // Must be unique on local network

// ThingSpeak Settings
char thingSpeakAddress[] = "api.thingspeak.com";
String writeAPIKey = "IO0RXCP673IH09XM";
...
void loop()
{
  ...
  String analogValue0 = String(analogRead(sensor_pin)*(4.76/1024), DEC);
  lcd.setCursor(0, 1);
